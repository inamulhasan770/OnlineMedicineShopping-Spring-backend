...
class OrderMedicineControllerIntegrationTest
{
	...
	void testAddOrderMedicine()
	{
		...
		ResponseEntity<OrderMedicine> postResponse = restTemplate
				.postForEntity(getRootUrl() + "/OrderMedicine/newOrderMedicine", orderMedicine, OrderMedicine.class);
	...
	void testUpdateOrderMedicine()
	{
		OrderMedicine orderMedicine = restTemplate.getForObject(getRootUrl() + "/OrderMedicine/101",
				OrderMedicine.class);
		assertEquals(101, orderMedicine.getOrderMedicineId());
